...
const AdvertiserLogin: React.FC<AdvertiserLoginProps> = ({ onSuccess, onBack }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (advertiser.status === 'pending_approval') {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Sign in to your advertiser account to manage your ads and campaigns.
        </p>
